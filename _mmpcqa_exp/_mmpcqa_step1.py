...
def train(args, k_fold_id):
    ...
    if source_database == 'SJTU':
        ...
        s_data_dir_2d = r"D:\xbx\data\mm_pcqa_data/sjtu/img"
        s_data_dir_pc = r"D:\xbx\data\mm_pcqa_data/sjtu/patch"
        if target_database == 'WPC':
            ...
            t_data_dir_2d = r'D:\xbx\data\mm_pcqa_data/wpc/img'
            t_data_dir_pc = r'D:\xbx\data\mm_pcqa_data/wpc/patch'
            ...
            t_data_dir_2d = r"D:\xbx\data\mm_pcqa_data/wpc2.0/img"
            t_data_dir_pc = r"D:\xbx\data\mm_pcqa_data/wpc2.0/patch"

    elif source_database == 'WPC':
        s_train_filename_list = 'datainfo/wpc_data_info/total.csv'
        s_data_dir_2d = r'D:\xbx\data\mm_pcqa_data/wpc/img'
        s_data_dir_pc = r'D:\xbx\data\mm_pcqa_data/wpc/patch'
        if target_database == 'SJTU':
            ...
            t_data_dir_2d = r"D:\xbx\data\mm_pcqa_data/sjtu/img"
            t_data_dir_pc = r"D:\xbx\data\mm_pcqa_data/sjtu/patch"
        elif target_database == 'WPC2.0':
            t_train_filename_list = f'datainfo/wpc2.0_data_info/train_{k_fold_id}.csv'
            t_test_filename_list = f'datainfo/wpc2.0_data_info/test_{k_fold_id}.csv'
            t_data_dir_2d = r"D:\xbx\data\mm_pcqa_data/wpc2.0/img"
        ...
        s_data_dir_2d = r'D:\xbx\data\mm_pcqa_data/wpc2.0/img'
        s_data_dir_pc = r'D:\xbx\data\mm_pcqa_data/wpc2.0/patch'
        if target_database == 'SJTU':
            t_train_filename_list = f'datainfo/sjtu_data_info/train_{k_fold_id}.csv'
            t_test_filename_list = f'datainfo/sjtu_data_info/test_{k_fold_id}.csv'
            t_data_dir_2d = r"D:\xbx\data\mm_pcqa_data/sjtu/img"
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(len_dataloader):
            ...
            t_imgs, t_pc, _ = data_target_iter.__next__()
