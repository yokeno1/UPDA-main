...
# swanlab.login(api_key="plLGtvorX3Wwg9qdvXasx",save=True)
...
def main(config, i_fold):
    ...
    # run = swanlab.init(
    #     project="UPDA-main",
    #     experiment_name="GMS-3DQA-Step2-5070Ti-WithStep1",
    #     description="不带粗粒度预训练",
    #     config=config,
    # )
    ...
    if config.target_database == 'SJTU':
        ...
        if config.source_database == 'WPC':
            ...
            source_images_dir = r'/mnt/d/xbx/data/wpc/img_6'
            target_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            test_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            ...
            source_images_dir = r'/mnt/d/xbx/data/wpc2.0/img_6'
            target_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            test_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            ...
            source_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            target_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            test_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
        ...
        if config.source_database == 'SJTU':
            ...
            source_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            target_images_dir = r'/mnt/d/xbx/data/wpc/img_6'
            test_images_dir = r'/mnt/d/xbx/data/wpc/img_6'
        ...
        if config.source_database == 'SJTU':
            ...
            source_images_dir = r'/mnt/d/xbx/data/sjtu/img_6'
            target_images_dir = r'/mnt/d/xbx/data/wpc2.0/img_6'
            test_images_dir = r'/mnt/d/xbx/data/wpc2.0/img_6'
    ...
    for epoch in range(config.epochs):
        ...
        for i in range(len_dataloader):
            ...
            feat_fusion, t_feat_fusion = model[1](feat, t_feat, if_fusion=True)
            # feat_fusion, t_feat_fusion = t_feat_fusion, feat_fusion
            ...
            loss_mse = criterion(score, labels_source)
            ...
            # swanlab.log({"loss": loss.detach(), "loss_ad": loss_ad.detach(), "loss_mse": loss_mse.detach()})
            if (i + 1) % 10 == 0:
        ...
        if total_loss/len_dataloader < min_loss:
            ...
            if not os.path.exists(config.ckpt_path + "/_gms/step2"):
                os.makedirs(config.ckpt_path + "/_gms/step2")

            filenamenew = os.path.join(config.ckpt_path + "/_gms/step2",
            ...
            # do validation after min loss epoch
            start = time.time()
            with torch.no_grad():
                model[0].eval()
                model[1].eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default='./checkpoint/_gms/step1', help='path for loading the checkpoint')
    # training parameters
