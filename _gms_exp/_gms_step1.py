...
def main(config, i_fold):
    ...
    for epoch in range(config.epochs):
        ...
        if total_loss/len_dataloader < min_loss:
            ...
            if not os.path.exists(config.ckpt_path + "/_gms/step1"):
                os.makedirs(config.ckpt_path + "/_gms/step1")

            filenamenew = os.path.join(config.ckpt_path + "/_gms/step1",
    ...
    print('Saving model to',
          os.path.join(config.ckpt_path + "/_gms/step1",
